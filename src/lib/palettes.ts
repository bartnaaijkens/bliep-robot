export type PaletteName = 'classic' | 'sunset' | 'mint'
...
export const BLIEP_PALETTES: Record<PaletteName, BliepPalette> = {
  classic: { blue: '#2E6FD8', deepBlue: '#1B4FB8', face: '#0A1633', glow: '#8FDBFF', cyan: '#5FC8FF' },
...
export const PALETTE_BG: Record<PaletteName, BgPalette> = {
  classic: { bg: '#F4EFE4', bgGlow: '#DDE9FF', ink: '#1B2748', soft: '#FAF6EC', line: '#E3DCC9' },
