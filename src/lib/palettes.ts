...
export const EXAMPLE_PROMPTS = [
  ...
  { label: 'Hoe zien katten \'s nachts?' },
  { label: 'Slapen haaien ooit?' },
  { label: 'Hoe ruiken honden zo goed?' },
  { label: 'Waarom kwaken kikkers?' },
  { label: 'Hoe groot wordt een octopus?' },
  { label: 'Wat is het grootste dier?' },
  ...
  { label: 'Wat is energie?' },
  { label: 'Hoe werkt geluid?' },
  { label: 'Hoe werkt DNA?' },
  { label: 'Zijn er parallelle werelden?' },
  ...
  { label: 'Wat is tijd?' },
  { label: 'Waarom bestaat er iets?' },
  { label: 'Wat zijn dromen eigenlijk?' },
  { label: 'Hoe weet je wat echt is?' },
]
